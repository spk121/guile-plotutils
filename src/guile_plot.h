...
#define INT_FUNC_PL_INT_INT_INT(CNAME, SNAME, FUNC)                           \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_x1, SCM s_x2)                     \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    int c_x0, c_x1, c_x2;                                                     \
                                                                              \
...
#define INT_FUNC_PL_VAL_VAL_VAL_VAL_VAL_VAL(CNAME, SNAME, PLOTFUNC,           \
                                            FPLOTFUNC)                        \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_x1, SCM s_y1, SCM s_x2, \
             SCM s_y2)                                                        \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    ...
    if (_scm_is_exact_integer (s_x0) && _scm_is_exact_integer (s_y0)          \
      ...
      {                                                                       \
        ...
        return scm_from_int (                                                 \
            PLOTFUNC (c_plotter, c_x0, c_y0, c_x1, c_y1, c_x2, c_y2));        \
      }                                                                       \
                                                                              \
    ...
    return scm_from_int (                                                     \
        FPLOTFUNC (c_plotter, c_dx0, c_dy0, c_dx1, c_dy1, c_dx2, c_dy2));     \
  }

#define INT_FUNC_PL_DOUBLE_DOUBLE_DOUBLE_DOUBLE_DOUBLE_DOUBLE(CNAME, SNAME,   \
                                                              FPLOTFUNC)      \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_x1, SCM s_y1, SCM s_x2, \
             SCM s_y2)                                                        \
  {                                                                           \
...
#define INT_FUNC_PL_DOUBLE_DOUBLE(CNAME, SNAME, FPLOTFUNC)                    \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0)                               \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    double c_dx0, c_dy0;                                                      \
                                                                              \
...
#define INT_FUNC_PL_STRING(CNAME, SNAME, FUNC)                                \
  SCM CNAME (SCM s_plotter, SCM s_str)                                        \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    char *c_str;                                                              \
    int c_ret;                                                                \
...
#define INT_FUNC_PL_INT(CNAME, SNAME, FUNC)                                   \
  SCM CNAME (SCM s_plotter, SCM s_x0)                                         \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    int c_x0;                                                                 \
                                                                              \
...
#define INT_FUNC_PL_VAL_VAL_VAL(CNAME, SNAME, PLOTFUNC, FPLOTFUNC)            \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_v)                      \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    int c_x0, c_y0, c_v;                                                      \
...
#define INT_FUNC_PL_VAL_VAL_VAL_VAL(CNAME, SNAME, PLOTFUNC, FPLOTFUNC)        \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_x1, SCM s_y1)           \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
...
#define INT_FUNC_PL_VAL_VAL_VAL_VAL_VAL(CNAME, SNAME, PLOTFUNC, FPLOTFUNC)    \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_x1, SCM s_y1, SCM s_v)  \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
    ...
    if (_scm_is_exact_integer (s_x0) && _scm_is_exact_integer (s_y0)          \
      ...
      {                                                                       \
        ...
        c_v = scm_to_int (s_v);                                               \
        return scm_from_int (                                                 \
            PLOTFUNC (c_plotter, c_x0, c_y0, c_x1, c_y1, c_v));               \
      }                                                                       \
                                                                              \
    c_dx0 = scm_to_double (s_x0);                                             \
    c_dy0 = scm_to_double (s_y0);                                             \
    ...
    c_dv = scm_to_double (s_v);                                               \
    return scm_from_int (                                                     \
        FPLOTFUNC (c_plotter, c_dx0, c_dy0, c_dx1, c_dy1, c_dv));             \
  }

#define INT_FUNC_PL_VAL_VAL_VAL_VAL_VAL_VAL_VAL_VAL(CNAME, SNAME, PLOTFUNC,   \
                                                    FPLOTFUNC)                \
  SCM CNAME (SCM s_plotter, SCM s_x0, SCM s_y0, SCM s_x1, SCM s_y1, SCM s_x2, \
             SCM s_y2, SCM s_x3, SCM s_y3)                                    \
  {                                                                           \
    plPlotter *c_plotter;                                                     \
